...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB14     ------> ADC1_IN5
    */
    HAL_GPIO_DeInit(BOARD_TEMP_GPIO_Port, BOARD_TEMP_Pin);

    HAL_GPIO_DeInit(RMC_CURRSENSE_GPIO_Port, RMC_CURRSENSE_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PD10     ------> ADC3_IN7
    */
    HAL_GPIO_DeInit(LMC_CURRSENSE_GPIO_Port, LMC_CURRSENSE_Pin);

    HAL_GPIO_DeInit(VBAT_SW_DIAG_GPIO_Port, VBAT_SW_DIAG_Pin);
